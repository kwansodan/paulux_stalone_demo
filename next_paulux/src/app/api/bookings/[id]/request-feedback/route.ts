    ...
    try {
        ...
        if (booking.clientPhone) {
            const message = reviewLink
                ? `Hi ${booking.clientName}, thank you for choosing Paulux for your ${serviceNames}! We'd love it if you could share your experience: ${reviewLink}`
                : `Hi ${booking.clientName}, thank you for choosing Paulux for your ${serviceNames}! We'd love to hear how it went — feel free to reply and let us know.`;
