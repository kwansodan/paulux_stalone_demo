...
export async function POST(request: NextRequest) {
    try {
        ...
        // The SDK connects to paulux_minio:9000 (internal Docker network) — no ETIMEDOUT.
        // The AWS Sig V4 signature includes Host: paulux_minio:9000.
        ...
        // Caddy forwards /files/* to paulux_minio:9000 using Host: paulux_minio:9000,
