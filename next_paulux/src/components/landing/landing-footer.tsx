  ...
  return (
    <footer className="bg-black space-y-12 text-white px-6 py-12">
      ...
      <div className="space-y-6 text-sm">
        ...
        <div>
          ...
          <div className="space-y-2 text-white/70">
            ...
            <p className="text-white/70 flex gap-2 items-center">
              ...
              <span>hello@pauluxbooking.com</span>
            </p>
            <p className="text-white/70 flex gap-2 items-center">
            ...
            <p className="text-white/70 flex gap-2 items-center">
              ...
              <Link href="https://wa.me/+233000000000" target="_blank" rel="noopener noreferrer">
                Chat on WhatsApp
              </Link>
            </p>
          </div>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-4">
            <Link href="https://www.facebook.com/pauluxbooking" target="_blank" rel="noopener noreferrer" className="text-white/70 flex gap-2 items-center hover:text-white transition-colors">
              {SOCIAL_ICONS.facebook()}
              <span>Facebook</span>
            </Link>
            <Link href="https://www.instagram.com/pauluxbooking" target="_blank" rel="noopener noreferrer" className="text-white/70 flex gap-2 items-center hover:text-white transition-colors">
              {SOCIAL_ICONS.instagram()}
              <span>Instagram</span>
            </Link>
            <Link href="https://www.tiktok.com/@pauluxbooking" target="_blank" rel="noopener noreferrer" className="text-white/70 flex gap-2 items-center hover:text-white transition-colors">
              {SOCIAL_ICONS.tiktok()}
              <span>TikTok</span>
            </Link>
            {/* <p className="text-white/70 flex gap-2 items-center">
      ...
      <div className="mt-10 text-xs text-white/70 flex flex-col items-start gap-3">
        <PolicyBottomSheet triggerLabel="Privacy Policy" title="Privacy Policy">
          <p className="mb-4 text-sm">
            Paulux, we respect your privacy and committed to protecting your personal information.
          </p>
      ...
      <p className="text-left text-xs text-white/50 mt-4">
        &copy; {new Date().getFullYear()} PauluxBooking. All rights reserved.
      </p>
    </footer>
  )
}