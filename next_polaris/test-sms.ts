...
async function test() {
    ...
    try {
        const result = await sendSMS({
            ...
            message: "This is a test message from Polaris Beauty Lounge. If you received this, your SMS service is working correctly."
        });
        ...
        if (result?.success) {
            ...
            if (result?.status === 401) {
                ...
                console.error("TIP: Check if your Sender ID 'Polaris' is approved in Arkesel.");
            }
        }
    } catch (error) {
