...
export default function ScheduleList({ bookings }: Props) {
  ...
  return (
    <div className="bg-white rounded-xl border p-4 sm:p-6 h-full flex flex-col">

      <div className="flex flex-row justify-between items-center mb-4 gap-2">
        <div>
          <h2 className="font-semibold text-base sm:text-lg text-gray-900">Today&apos;s Schedule</h2>
