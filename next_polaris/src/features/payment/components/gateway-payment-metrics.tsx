...
import { RefreshCw, Clock, TrendingUp, Wallet } from "lucide-react"
import MetricCard from "@/components/metric-card"
import { Button } from "@/components/ui/button"
import { useGatewayPaymentMetrics } from "../client/use-payment"
import { GatewayPaymentMetrics as IGatewayPaymentMetrics } from "../types"
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-semibold text-gray-900">Gateway Routing</h1>
          <p className="text-[16px] text-gray-600">
            Monitor daily distribution and gateway health
          </p>
        </div>
