  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <MetricCard title="Total Deposits Received Today" value={`GHS ${data.totalDepositsToday.toFixed(2)}`} icon={
        ...
        <MetricCard title="Total Balance Due " value={`GHS ${data.totalBalanceDueToday.toFixed(2) || 0}`} icon={<Wallet />} iconClassName="bg-[#FFFBEB] text-[#973C00]" />
